...
echo -e "   \033[45m \033[103m \033[107m\033[30m ERROR DE KEY POR FAVOR DE VERIFICAR\033[103m \033[45m \e[0m"
[[ "$list_fix" = "" ]] && {
msg -bar3 
echo -e " ERROR (PORT 8888 TCP) ENTRE GENERADOR <--> VPS "
echo -e "    NO EXISTE CONEXION ENTRE EL GENERADOR "
...
#figlet " Key Invalida" | boxes -d stone -p a2v1 > error.log
msg -bar3 >> error.log
echo "  Contacta con tu Provehedor" >> error.log
echo -e ' Para verificar el error ' >> error.log
msg -bar3 >> error.log
#cat error.log | lolcat
#msg -bar3
#echo -e "    \033[1;44m  DESEAS REINTENTAR ---\033[0;33m  "
echo -e "\033[1;37m DESEAS REINTENTAR CON OTRA KEY\033[1;32m.\033[1;32m.\033[1;33m.\033[1;31m. \033[1;33m"
echo -ne "\033[0;32m "
...
echo -ne " " && msg -bar3
echo -ne " \033[1;41m Clave : \033[0;33m" && read Key
tput cuu1 && tput dl1
done
